...
To make hot module replacement work, add the following to the config object in next.config.js:
[source,javascript]
----
module.exports = {
...
WARNING: Hot Module Reloading (HMR) is currently not working in DEV mode. See https://github.com/vercel/next.js/discussions/47000[Next.js Discussion] 
