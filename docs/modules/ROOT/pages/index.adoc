...
quarkus.quinoa.package-manager-install.node-version=18.16.0 <2>
----
...
[#solidjs]
=== SolidJS
Any app created with https://www.solidjs.com/[SolidJS] are compatible without any change and Hot Module Replacement (HMR) should work by default. It is based on link:#vite[Vite].
