...
a|icon:lock[title=Fixed at build time] [[quarkus-quinoa_quarkus.quinoa.ui-base-path]]`link:#quarkus-quinoa_quarkus.quinoa.ui-base-path[quarkus.quinoa.ui-base-path]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_QUINOA_UI_BASE_PATH+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_QUINOA_UI_BASE_PATH+++`
endif::add-copy-button-to-env-var[]
--|string 
|`/`
