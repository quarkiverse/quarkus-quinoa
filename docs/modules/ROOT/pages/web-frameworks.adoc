...
----
a|
- https://aurelia.io/docs/tutorials/creating-a-todo-app#setup[Aurelia]
|
...
----
a|
- https://polymer-library.polymer-project.org/3.0/docs/first-element/intro[Polymer]
|
...
----
a|
- https://qwik.builder.io/docs/getting-started/[Qwik]
|
...
----
a|
- https://cycle.js.org/getting-started.html[Cycle]
|
...
----
a|
- https://refine.dev/docs/getting-started/quickstart/[Refine]
|
...
It will work in production mode though with the following chnages:
